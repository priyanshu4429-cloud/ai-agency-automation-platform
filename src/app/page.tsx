...
export default function Home() {
  ...
  return (
    <div className="relative min-h-screen overflow-x-hidden bg-white text-slate-800 font-sans selection:bg-blue-100">
          ...
          {mobileMenuOpen && (
            ...
            >
              <div className="px-6 py-6 space-y-4">
                ...
                <a href="#projects" className="block text-lg font-bold text-slate-700" onClick={() => setMobileMenuOpen(false)}>Projects</a>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-blue-100 text-blue-700 mb-6 font-bold text-sm shadow-sm border border-blue-200/50">
                ...
                <span>No. 1 Website Development Company</span>
              </div>
              ...
              <p className="text-lg sm:text-xl text-slate-600 mb-8 max-w-xl mx-auto lg:mx-0 leading-relaxed font-medium">
                100% Trusted Web Development Company providing robust multi-functional web portals and ROI-driven digital solutions.
              </p>
            ...
            >
              {/* Premium Floating Illustration Mockup */}
              <div className="relative w-full aspect-square">
                <motion.div 
                  animate={{ y: [-10, 10, -10] }} 
                  transition={{ duration: 6, repeat: Infinity, ease: "easeInOut" }}
                  className="absolute inset-0 bg-gradient-to-tr from-blue-600 to-purple-600 rounded-3xl shadow-2xl overflow-hidden flex items-center justify-center p-8"
                >
                  <div className="w-full h-full bg-white rounded-2xl shadow-inner relative overflow-hidden flex flex-col">
                    ...
                    <div className="flex-1 p-6 flex flex-col gap-4">
                      <div className="w-3/4 h-8 bg-slate-200 rounded-lg animate-pulse"></div>
                ...
                <motion.div 
                  ...
                  className="absolute -bottom-8 -left-8 bg-white p-4 rounded-2xl shadow-xl flex items-center gap-4 border border-slate-100"
                >
                  <div className="w-12 h-12 bg-green-100 text-green-600 rounded-xl flex items-center justify-center">
                    <CheckCircle2 className="w-6 h-6" />
                  </div>
                  <div>
                    <div className="font-bold text-slate-800">100% Trusted</div>
                    <div className="text-xs text-slate-500">ROI-driven results</div>
                  </div>
                </motion.div>
              </div>
            </motion.div>
      ...
      <section id="services" className="py-24 px-4 bg-white relative">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl sm:text-5xl font-black text-slate-900 mb-6 tracking-tight">Services</h2>
          ...
          <div className="bg-white rounded-[2rem] border border-slate-200 shadow-2xl overflow-hidden flex flex-col lg:flex-row min-h-[500px]">
            {/* Sidebar Tabs */}
      ...
      {/* Pricing Section */}
      <section id="pricing" className="py-24 px-4 bg-slate-50 relative">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            {pricingPlans.map((plan, i) => (
              ...
              >
                <div className="p-8 sm:p-10 text-center relative">
                  {/* Package Title Tag */}
                  <div className={`inline-block px-6 py-2 rounded-full font-bold text-sm mb-8 ${plan.popular ? "bg-orange-500 text-white" : "bg-red-500 text-white"}`}>
                    {plan.name}
                  </div>
                  ...
                  <div className="w-40 h-40 mx-auto mb-8 relative">
                     ...
                     <div className={`relative z-10 w-full h-full rounded-full border-4 flex items-center justify-center ${plan.popular ? "border-blue-400 bg-blue-600" : "border-slate-100 bg-white"}`}>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-6 text-sm text-slate-500">
            ...
            <div className="flex items-center gap-4">
              <Link href="/login" className="px-4 py-2 rounded-lg bg-white/10 hover:bg-white/20 font-bold text-white transition-colors flex items-center gap-2">
                <Lock className="w-4 h-4" /> Team Login
              </Link>
            </div>
          </div>
